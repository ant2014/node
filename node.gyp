  ...
  'targets': [
    {
      ...
      'sources': [
        ...
        'src/uv.cc',
        # cpu-intensive
        'src/node_transmit.cc',
        'multithread/PendingTask.cc',
        'multithread/ref_counted.cc',
        'multithread/Thread.cc',
        'multithread/WeakPtr.cc',
        'multithread/lazy_instance.cc',
        'multithread/MessageLoop.cc',
        'multithread/MessagePumpDefault.cc',
        'multithread/util_tools.cc',
        'multithread/at_exist.cc',
        'multithread/time/time.cc',
        'multithread/Event/WaitableEvent.cc',
        ...
        # cpu-intensive
        'multithread/Event/WaitableEvent.h',
        'multithread/time/time.h',
        'multithread/FastDelegateImpl.h',
        'multithread/MessagePumpDefault.h',
        'multithread/MessageLoop.h',
        'multithread/FastDelegate.h',
        'multithread/MessagePump.h',
        'multithread/WrapperObj.h',
        'multithread/WeakPtr.h',
        'multithread/util_tools.h',
        'multithread/PendingTask.h',
        'multithread/ref_counted.h',
        'multithread/Thread.h',
        'multithread/macros.h',
        'multithread/observer_list.h',
        'multithread/lazy_instance.h',
        'multithread/aligned_memory.h',
        'multithread/thread_local.h',
        'multithread/at_exist.h',
        'src/node_transmit.h',
